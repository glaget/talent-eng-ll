...
@mark.parametrize(
    ...
    [
        ...
        param([1, 2, 3, 4], tuple, marks=mark.xfail(reason="list is not a tuple")),
        param(
            [x * 2 for x in range(100)],
            str,
            marks=mark.xfail(reason="list is not a str"),
        ),
        param(list("abcdefg"), bool, marks=mark.xfail(reason="list is not a bool")),
        param((1, 2, 3, 4), list, marks=mark.xfail(reason="tuple is not a list")),
        param(
            tuple([x * 2 for x in range(100)]),
            int,
