...
class TestDatabaseConnection:
    def test_check_connected(self, database_provider_fixture):
        assert (
            database_provider_fixture.connected
            and database_provider_fixture.tables is not None
        )
    ...
    def test_check_not_connected_while_connected(self, database_provider_fixture):
        ...
        assert (
            not database_provider_fixture.connected
            and database_provider_fixture.tables is None
        )
